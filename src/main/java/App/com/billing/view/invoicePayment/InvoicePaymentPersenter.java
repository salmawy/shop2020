...
//=============================================================================================================================================
 ...
 //=============================================================================================================================================
	...
	private void loadSuggestedInvoices() {
		...
		List<InvoiceViewbean> invoicsViewBeans=new ArrayList();
		try {
			...
			invoices = this.getBillingService().getSuggestedOrders(0,1, 0, ApplicationContext.season.getId(), 0, ApplicationContext.fridage.getId());
	...
	private void loadSuggestedInvoices(int customerId) {
		...
		try {
			...
			invoices = this.getBillingService().getSuggestedOrders(customerId,1, 0, ApplicationContext.season.getId(), 0, ApplicationContext.fridage.getId());
