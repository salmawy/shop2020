package App.com.contractor.view.AddVaraity;
...
//============================================================================================================
 ...
 private void save() {
	if (validateForm()) {
		...
		try {
			this.getContractorService().contractorTransaction(name, ContractorTypeEnum.LABOUR, amount, ApplicationContext.fridage.getId(), notes, paid, ownerId, date, ApplicationContext.season.getId());
