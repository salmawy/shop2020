package App.com.contractor.view.addSupplier;
...
//============================================================================================================
 ...
 private void save() {
	if (validateForm()) {
		...
		try {
			this.getContractorService().contractorTransaction(name, ContractorTypeEnum.SUPPLIER_, amount, ApplicationContext.fridage.getId(), notes, paid, ownerId, date, ApplicationContext.season.getId());
