package App.com.inventory.view.main;
...
public class InventoryPersenter extends SalesAction implements Initializable, CustomTableActions{
 ...
 //--------------------------------------------------------------------------------------------------------------------------------------------
	  	...
	  	fillDates(ApplicationContext.season.getId());
...
//--------------------------------------------------------------------------------------------------------------------------------------
 ...
 //====================================================================================================
    ...
    void fillDates(int seasonId) {
    	List dates;
		try {
			dates = getInventoryService().getInventoryDates(ApplicationContext.season.getId());
