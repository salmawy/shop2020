package App.com.expanses.view.loan;
...
import App.com.expanses.view.beans.LoanersNameVB;
import App.com.expanses.view.payLoan.PayLoanView;
...
void initiateInLoanPage(){
    ...
    Double amount=0.0;
	try {
		amount = (Double) this.getBaseRetrievalService().aggregate("LoanAccount", "sum", "dueAmount", map);
	} catch (DataBaseException | EmptyResultSetException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
...
public void rowSelected(Object table) {
	...
	String type=(loanType_combo.getSelectionModel().getSelectedItem().getValue()==1)?inLoan:outLoan;
