package App.com.expanses.view.addIncome;
...
//---------------------------------------------------------------------------------------------------------------
		...
		boolean validateInForm() {
			   ...
			   String inAmount = incomeAmount_TF.getText(); LoanAccount account =
			  this.getExpansesServices().getLoanerAccount(name);
		  ...
		  void intiateInPage() {
			...
			case edit:
				...
				try {
					...
					IncomeDetail detail=(IncomeDetail) this.getBaseService().getBean(Income.class, incomeDetailId);
					Contractor contractor=(Contractor) this.getBaseService().getBean(Contractor.class, detail.getSellerId());
...
//---------------------------------------------------------------------------------------------------------------
			...
			private void saveIncome() {
				  ...
				  int typeId =
				  incomeType_combo.getSelectionModel().getSelectedItem().getValue(); double
				  ...
				  Date(), amount, typeId, notes, ApplicationContext.fridage.getId());
